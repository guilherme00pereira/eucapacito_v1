                    ...
                    <form sx={styles.form}>
                        ...
                        <Container sx={styles.formSecondContainer}>
                            <FormControl>
                                ...
                                <Box sx={styles.dataN}>
                                    <OutlinedInput required id="b_day" value={fields.b_day} type="text"
                                                   inputProps={{maxLength: 2}} onChange={handleFieldChange("b_day")}/>
                                    <OutlinedInput required id="b_month" value={fields.b_month} type="text"
                                                   inputProps={{maxLength: 2}} onChange={handleFieldChange("b_month")}/>
                                    <OutlinedInput required id="b_year" value={fields.b_year} type="text"
                                                   inputProps={{maxLength: 4}} onChange={handleFieldChange("b_year")}/>
                                </Box>
                            </FormControl>
                            ...
                            <FormControl>
                                ...
                                <Box sx={styles.cel}>
                                    <OutlinedInput required id="phone_ddd" value={fields.phone_ddd} type="text"
                                                   ...
                                                   onChange={handleFieldChange("phone_ddd")}/>
                            ...
                            <FormControl>
                                ...
                                <Select required id="state" value={fields.state} type="text"
